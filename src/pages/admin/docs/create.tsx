      ...
      <div className="container mx-auto py-8">
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-4">
            <button className="bg-gray-900 rounded-xl w-12 h-12 flex items-center justify-center border border-gray-700" onClick={() => window.history.back()}>
        ...
        <div className="mb-5">
          <label htmlFor="slug" className="block mb-2 font-bold">執筆者名</label>
          <input
            id="slug"
            type="text"
            value={slug}
        ...
        <div className="mb-5">
          <label htmlFor="sidebarLabel" className="block mb-2 font-bold">タイトル</label>
          <input
            id="sidebarLabel"
            type="text"
            value={sidebarLabel}
        ...
        <div className="mb-5">
          <label htmlFor="public-select" className="block mb-2 font-bold">公開設定</label>
          <select 
            name="public" 
            id="public-select" 
            className="w-full p-2.5 border border-gray-700 rounded bg-transparent text-white"
        ...
        <div className="grid grid-cols-12 gap-4 mt-8">
          ...
          <label htmlFor="body" className="block mb-2 font-bold">本文</label>
          ...
          <div className="col-span-6">
          <label htmlFor="preview" className="block mb-2 font-bold">プレビュー</label>
            <div className="w-full p-2.5 border border-gray-700 rounded bg-transparent text-white">
              <div className="card__body">
