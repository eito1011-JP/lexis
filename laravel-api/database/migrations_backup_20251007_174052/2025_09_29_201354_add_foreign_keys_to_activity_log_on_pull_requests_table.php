...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('activity_log_on_pull_requests', function (Blueprint $table) {
            ...
            $table->foreign(['pull_request_edit_session_id'], 'fk_activity_log_pr_edit_session_id')->references(['id'])->on('pull_request_edit_sessions')->onUpdate('no action')->onDelete('cascade');
    ...
    public function down(): void
    {
        Schema::table('activity_log_on_pull_requests', function (Blueprint $table) {
            ...
            $table->dropForeign('fk_activity_log_pr_edit_session_id');
